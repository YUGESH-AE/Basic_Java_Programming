package Java_Se8.javaSE8Features.LambdaExpression.ConsumerFunctional2;
...
public class Main {
    public static void main(String[] args) {
        ...
        consume(lstEmp,employee -> System.out.println(employee.getId()+" "+ employee.getSal())) ;

    }
    public static void consume(List<Employee> e, Consumer<Employee> c){
        for (Employee i:e){
            c.accept(i);
        }
    }
